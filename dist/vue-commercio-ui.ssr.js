...
var __vue_staticRenderFns__$1 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$1 = "data-v-f7979248";
  /* functional template */
...
var __vue_staticRenderFns__$2 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$2 = "data-v-fdac8340";
  /* functional template */
...
/* template */
var __vue_render__$3 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.items.length > 0)?_vm._ssrNode("<div data-test=\"items\">","</div>",[_vm._ssrNode("<ul class=\"list-group list-group-flush\">","</ul>",_vm._l((_vm.items),function(item,index){return _vm._ssrNode("<li class=\"list-group-item\">","</li>",[_vm._t("default",null,{"data":item})],2)}),0)]):_vm._e(),_vm._ssrNode(" "+((_vm.isFetching)?("<div data-test=\"loading\" class=\"com-font-s14-w700\">"+(_vm._s(_vm.loadingMessage))+"</div>"):"<!---->")+" "+((!_vm.isFetching && _vm.items.length <= 0)?("<div data-test=\"empty-list\" class=\"py-3 com-font-s14-w700\">"+(_vm._s(_vm.emptyMessage))+"</div>"):"<!---->"))],2)};
var __vue_staticRenderFns__$3 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$3 = "data-v-16396214";
  /* functional template */
...
var __vue_staticRenderFns__$4 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$4 = "data-v-374afa27";
  /* functional template */
...
/* template */
var __vue_render__$5 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"row d-flex align-items-center"},[_vm._ssrNode("<div class=\"col-2 col-sm-1 d-flex justify-content-center\">","</div>",[_vm._t("left-content")],2),_vm._ssrNode(" <div class=\"col-8 col-sm-10 d-flex justify-content-center\"><form><input type=\"text\""+(_vm._ssrAttr("placeholder",_vm.placeholderMessage))+" aria-label=\"Search\" aria-describedby=\"search-field\""+(_vm._ssrAttr("value",(_vm.query)))+(_vm._ssrClass("form-control bg-light rounded-pill",_vm.placeholderStyle))+"></form></div> "),_vm._ssrNode("<div class=\"col-2 col-sm-1 d-flex justify-content-center\">","</div>",[_vm._t("right-content")],2)],2)};
var __vue_staticRenderFns__$5 = [];
  ...
  /* module identifier */
  var __vue_module_identifier__$5 = "data-v-8b25608c";
  /* functional template */
  ...
  var SearchBar = normalizeComponent_1(
    ...
    undefined,
    undefined
  );/* eslint-disable import/prefer-default-export */var components = /*#__PURE__*/Object.freeze({VueCommercioUiSample: vueCommercioUiSample,ListRowCol183: ListRowCol183,ListRowCol192: ListRowCol192,ListView: ListView,NavBar: NavBar,SearchBar: SearchBar});// Import vue components
...
}exports.ListRowCol183=ListRowCol183;exports.ListRowCol192=ListRowCol192;exports.ListView=ListView;exports.NavBar=NavBar;exports.SearchBar=SearchBar;exports.VueCommercioUiSample=vueCommercioUiSample;exports.default=plugin;